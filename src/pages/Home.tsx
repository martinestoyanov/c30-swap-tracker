...
import Vida from "@/sections/Vida";
import { LayoutDashboard, ListChecks, ShoppingCart, Wallet, BookOpen, BookMarked, Wrench, Cloud, HardDrive } from "lucide-react";
...
const TABS = [
  ...
  { id: "vida", label: "VIDA", icon: BookMarked, el: <Vida /> },
] as const;
